# Generated by Powerlevel10k configuration wizard on 2026-03-24 at 16:58 CET.
...
#  typeset -g POWERLEVEL9K_CONTEXT_{DEFAULT,SUDO}_{CONTENT,VISUAL_IDENTIFIER}_EXPANSION=
  ...
  typeset -g POWERLEVEL9K_PUBLIC_IP_BACKGROUND=4
  # Custom icon.
...
typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%Y-%m-%dT%H:%M:%S%z}'
